...
api_router.include_router(employment.router, prefix="/employment", tags=["employment"])
api_router.include_router(position.router, prefix="/position", tags=["position"])
api_router.include_router(schedule.router, prefix="/schedule", tags=["schedule"])
api_router.include_router(schedule_user.router, prefix="/schedule_user", tags=["schedule_user"])
